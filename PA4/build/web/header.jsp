...
<html>
    ...
    <body>     
    <h1 style="text-align: center; font:Helvetica Neue; margin-top: 1.5em;"></h1>
    
    <c:if test ="${user != null && success}"> 
        <div class="menu">
            <span class ="menuOpt" id = "home">  <a href="registration?action=home">Home</a></span>
            <span class ="menuOpt" id = "noti">  <a href="registration?action=notification">Notification</a></span>
